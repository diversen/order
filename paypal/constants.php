...
define('API_USERNAME', config::getModuleIni('order_paypal_username'));
//
...
define('API_PASSWORD', config::getModuleIni('order_paypal_password'));

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/

define('API_SIGNATURE', config::getModuleIni('order_paypal_signature'));
