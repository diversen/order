...
define('API_USERNAME', get_module_ini('order_paypal_username'));
//
...
define('API_PASSWORD', get_module_ini('order_paypal_password'));

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/

define('API_SIGNATURE', get_module_ini('order_paypal_signature'));
