...
<tr>
    <td><?=lang::translate('order_legend_diffent_shipping')?></td>
...
<table class="checkout">
    <tr>
    <td>&nbsp;</td>
    <td><input type="submit" name="submit" value="<?=lang::translate('order_legend_add_order_button')?>" /></td>
    </tr>
</table>
