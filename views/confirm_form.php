...
<tr>
<td><h3><?=lang::translate('invoice_details')?></h3></td>
<?php
if (isset($_POST['checkme'])){ ?>
<td><h3><?=lang::translate('different_shipping')?></h3></td>
<td>&nbsp;</td>
<? } else { ?>
<td>&nbsp;</td>
<? } ?>
...
<table class="order_cart">
<tr>
    <td><input type="submit" name="submit" value="<?=lang::translate('confirm_order')?>" /></td>
</tr>
</table>
